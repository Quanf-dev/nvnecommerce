...
const UserDashboardPage2 = () => {
  return (
    <section className="py-8 antialiased bg-white dark:bg-gray-900 md:py-8">
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
              <div className="flex items-center">
                <svg
                  className="w-4 h-4 mx-1 text-gray-400 rtl:rotate-180"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                ...
                <a
                  href="#"
                  className="text-sm font-medium text-gray-700 ms-1 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2"
                >
                  My account
                </a>
              </div>
            ...
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="text-sm font-medium text-gray-500 ms-1 dark:text-gray-400 md:ms-2">
                  Account
                </span>
              </div>
            </li>
            ...
            <div className="space-y-4">
              ...
              <dl>
                ...
                <dd className="flex items-center gap-1 text-gray-500 dark:text-gray-400">
                  <svg
                    className="hidden w-5 h-5 text-gray-400 shrink-0 dark:text-gray-500 lg:inline"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
              ...
              <dl>
                ...
                <dd className="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
                  <div className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-lg shrink-0 dark:bg-gray-700">
                    ...
                    />
                    <img
                      className="hidden w-auto h-4 dark:flex"
          ...
          <div className="flex flex-wrap items-center pb-4 border-b border-gray-200 gap-y-4 dark:border-gray-700 md:pb-5">
            ...
            <div className="w-full sm:flex sm:w-32 sm:items-center sm:justify-end sm:gap-4">
              ...
              <div
                ...
                className="z-10 hidden w-40 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
                data-popper-reference-hidden=""
                data-popper-escaped=""
                data-popper-placement="bottom"
              >
                <ul
                  className="p-2 text-sm font-medium text-left text-gray-500 dark:text-gray-400"
                  aria-labelledby="actionsMenuDropdown10"
                >
                  <li>
                    <a
                      href="#"
                      className="inline-flex items-center w-full px-3 py-2 text-sm text-gray-500 rounded-md group hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
                    >
                      <svg
                  ...
                  <li>
                    <a
                      ...
                      className="inline-flex items-center w-full px-3 py-2 text-sm text-red-600 rounded-md group hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                    >
                      <svg
      ...
      >
        <div className="relative w-full max-w-lg max-h-full p-4 max-h-auto">
                ...
                <div className="col-span-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <div
                      ...
                      className="z-10 hidden w-56 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
                    >
                      <ul
                      ...
                      >
                        <li>
                          <button
                            type="button"
                            className="inline-flex w-full px-3 py-2 text-sm text-gray-500 rounded-md hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
                            role="menuitem"
                          >
      ...
      <div
        ...
        tabindex="-1"
        aria-hidden="true"
        className="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full overflow-x-hidden overflow-y-auto h-modal md:inset-0 md:h-full"
      >
        <div className="relative w-full h-full max-w-md p-4 md:h-auto">
          <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <button
                type="submit"
                className="px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
              >
                Yes, delete
              </button>
            </div>
